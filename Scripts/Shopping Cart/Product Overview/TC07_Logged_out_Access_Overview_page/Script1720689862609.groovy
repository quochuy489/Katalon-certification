...
WebUI.waitForElementPresent(findTestObject('Object Repository/Shopping Cart/Dashboard/Product_item', [('product_name'):'Basic Top']), 5)

WebUI.click(findTestObject('Object Repository/Shopping Cart/Dashboard/Product_item', [('product_name'):'Basic Top']))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Shopping Cart/Product Overview/Product_Overview_page'), 5)
