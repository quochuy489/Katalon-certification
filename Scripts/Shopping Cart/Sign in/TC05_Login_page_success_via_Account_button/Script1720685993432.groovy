...
WebUI.verifyElementPresent(findTestObject('Object Repository/Shopping Cart/Dashboard/Dashboard_page'), 10)

WebUI.waitForElementPresent(findTestObject('Object Repository/Shopping Cart/Header/User_icon_logged_out'), 10)

WebUI.click(findTestObject('Object Repository/Shopping Cart/Header/User_icon_logged_out'))
