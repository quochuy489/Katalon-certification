...
//Create a test case to check redirection to Home page when clicking on "Home" on Burger menu
...
WebUI.click(findTestObject('Object Repository/Healthcare/Burger menu/a_Home'))
