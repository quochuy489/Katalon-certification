...
WebUI.waitForElementPresent(findTestObject('Object Repository/Header/User_icon_logged_out'), 10)

WebUI.click(findTestObject('Object Repository/Header/User_icon_logged_out'))
