...
WebUI.click(findTestObject('Object Repository/Product Overview/Buy_now_button'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Sign in/Sign_in_page'), 5)
